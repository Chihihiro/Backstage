...
class DRB(BaseSpider):
    ...
    def get_info(self):
        ...
        # 设置头部信息
        headers = {
            "Host": "drbopenback.yueguangyouka.com",
            "Referer": "http://drbopenback.yueguangyouka.com/channel/getChannelStatistics",
            "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.80 Safari/537.36",
        }
        # 页面url
        page_url = f"http://drbopenback.yueguangyouka.com/channel/getChannelStatistics?channelName=&channelCode={self.channel}&startDate={self.today}&endDate={self.today}&numPerPage=10&pageNum=1&xzOldPageNum=1"
        # 请求url
...
SH = {
    "login_url": "http://drbopenback.yueguangyouka.com/user/login",
    "area": "外地",
    "product": "点容宝",
