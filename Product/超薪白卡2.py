...
class CXBK(BaseSpider):
    ...
    def get_info(self):
        ...
        # json的url
        json_url = f"http://chaoxinbaika.xingyunqianbao.net/Mwsad/Platlogin/index"
        # 设置session
        ...
        # 获取认证用户
        apply_user = selector.xpath('//div[@class="mt-10"]/div[1]/span[@class="r"]/strong/text()').extract()[0]
        # 获取注册数量
        register_user = selector.xpath('//div[@class="mt-10"]/div[2]/span[@class="r"]/strong/text()').extract()[0]
        # 获取结果
        result = {
            "注册人数": register_user,
            "实名人数": "null",
...
WD = {
    "login_url": "http://chaoxinbaika.xingyunqianbao.net/Mwsad/Platlogin/index",
    "area": "上海",
    "product": "超薪白卡",
    "username": "富018",
    "password": "123456",
