...
def TestFunc(pred_type, file_name):
    pd_id = "109051"  # 用户中心页可以查询到pd信息
    pd_key = "hmYPSRjWe2mDmEutZCY2EntOrou//Eqt"
    app_id = "309051"  # 开发者分成用的账号，在开发者中心可以查询到
    app_key = "uXlUOkhG/b4JColu3N9ubSsXINu636Gw"
    # 识别类型，
    ...
    rsp = api.PredictFromFile(pred_type, "../Image/"+file_name)  # 返回详细识别结果
